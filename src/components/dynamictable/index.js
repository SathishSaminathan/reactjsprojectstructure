...
class Dynamictable extends React.Component {
  constructor(props) {
    ...
    this.columns = [
      ...
      },
      {
        ...
        width:'30%',
        render: () => (
          <Select placeholder="Please select type" defaultValue = {this.state.selectvalue} onChange={this.handlechange}>
            <Option value="contract">Contract</Option>
            <Option value="perday">PerDay</Option>
            <Option value="percallsheet">PerCallSheet</Option>
          </Select>
        )
      },
  ...
  handleSave = row => {
    ...
    this.setState({ dataSource: newData },()=>console.log("handlestaff child..",newData));
